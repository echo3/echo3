...
extends LayoutDataPeer {
    ...
    throws SerialException {
        ...
        SerialUtil.toXml(context, GridLayoutData.class, propertyElement, "alignment", layoutData.getAlignment());
        SerialUtil.toXml(context, GridLayoutData.class, propertyElement, "background", layoutData.getBackground());
        SerialUtil.toXml(context, GridLayoutData.class, propertyElement, "backgroundImage", layoutData.getBackgroundImage());
        SerialUtil.toXml(context, GridLayoutData.class, propertyElement, "insets", layoutData.getInsets());

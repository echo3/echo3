...
/**
 * Unit test(s) for <code>nextapp.echo.app.componentxml.propertypeer.IntegerPeer</code>.
 */
public class IntegerPeerTest extends TestCase {
    ...
    public void testBasic() {
        Style charlieStyle = styleSheet.getStyle("charlie", Grid.class, true);
        assertEquals(new Integer(0), charlieStyle.getProperty("orientation"));
    }
    
    public void testIntrospectedConstant() {
        Style deltaStyle = styleSheet.getStyle("delta", Grid.class, true);

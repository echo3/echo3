...
/**
 * Synchronization peer for <code>Label</code>s.
 */
public class LabelPeer extends AbstractComponentSynchronizePeer {
    ...
    private static final Service LABEL_SERVICE = JavaScriptService.forResource("Echo.Label", 
            "/nextapp/echo/webcontainer/resource/js/Render.Label.js");
    ...
    public void init(Context context) {
        ...
        outputContext.getServerMessage().addLibrary(LABEL_SERVICE.getId());
    }
}

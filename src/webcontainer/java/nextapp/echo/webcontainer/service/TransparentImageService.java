...
/**
 * Service for transparent images.
 * 
 * @author n.beekman
 */
public class TransparentImageService {

    public static final Service INSTANCE = StaticBinaryService.forResource(
            "Echo.TransparentImage", "image/gif", "/nextapp/echo/webcontainer/resource/image/Transparent.gif");

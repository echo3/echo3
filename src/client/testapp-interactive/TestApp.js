    ...
    $construct: function() {
        ...
        var grid = new Echo.Grid({
            ...
            children: [
                ...
                new Echo.Button({ text: "text", icon: img, height: "55px", background: "magenta", alignment: middlealign, textPosition: textPosLeft}),
                ...
                new Echo.RadioButton({ text: "text", icon: img, height: "55px", background: "magenta", alignment: middlealign, textPosition: textPosLeft}),
                ...
                new Echo.CheckBox({ text: "text", icon: img, height: "55px", background: "magenta", alignment: middlealign, textPosition: textPosLeft}),
                ...
                new Echo.Button({ text: "text", icon: img, height: "55px", background: "magenta", alignment: rightalign, textPosition: textPosLeft}),
                ...
                new Echo.RadioButton({ text: "text", icon: img, height: "55px", background: "magenta", alignment: rightalign, textPosition: textPosLeft}),
                ...
                new Echo.CheckBox({ text: "text", icon: img, height: "55px", background: "magenta", alignment: rightalign, textPosition: textPosLeft}),
                ...
                new Echo.Button({ text: "text", icon: img, height: "55px", background: "magenta", alignment: bottomalign, textPosition: textPosLeft}),
                ...
                new Echo.RadioButton({ text: "text", icon: img, height: "55px", background: "magenta", alignment: bottomalign, textPosition: textPosLeft}),
                ...
                new Echo.CheckBox({ text: "text", icon: img, height: "55px", background: "magenta", alignment: bottomalign, textPosition: textPosLeft}),
